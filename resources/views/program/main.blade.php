...
<div class=" ">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 ">
        ...
        <div class="flex flex-col items-center justify-center text-left">
            <h2 class="header_2 responsive-padding">
        ...
        <div class="flex justify-center order-2 sm:order-1">
            <img class="Image  w-full h-[518px] md:h-[496px] relative"src="{{ asset('images/program/satisfaction_2.png') }}" alt="Coffee Machine" />
        </div>
    ...
    {{-- <div class="text-center mb-8">
       ...
       <h1 class="header_1 responsive-padding">
            Partnering: As Easy As...
        </h1>
    <div class="responsive-padding grid grid-cols-1 sm:grid-cols-3 gap-4">
