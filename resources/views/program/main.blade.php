...
<div class="">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="flex flex-col md:flex-row items-center justify-start md:gap-4">
                ...
                <div class="flex items-center md:gap-4">
                    <div class="header_1 text-white md:gap-2 ">to</div>
                    <div class="mt-2 md:gap-2 ">
                        <div class="w-[63px] h-[40px] md:h-[50px] bg-no-repeat bg-center bg-contain" style="background-image: url('/images/illy_white.svg');"></div>
                    </div>

                    <div class="header_1 text-white md:gap-2 ">today</div>
                </div>
            </div>
            <div class="flex flex-col md:flex-row justify-end items-center gap-2 md:gap-4 mt-10 md:mt-0">
                <div id="btn_getInTouch" class="btn_red  md:mt-0">
                    <a id="get-in-touch-button" href="#prepango-get-in-touch" > Get In Touch </a>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 ">
        ...
        <div class="flex flex-col items-center  text-left order-1 sm:order-2 ">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 xl:grid-cols-5 gap-4 justify-center responsive-padding">
                <div class="flex flex-col items-center">
                    <i class="fa fa-plane md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Airport</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-graduation-cap md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Apartments and Condos</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-building md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Colleges and Universities</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-car-side md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Auto Dealerships</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-users md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Campus Hubs</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-school-flag md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Clubs and Clubhouses</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-house-laptop md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Corporate Offices</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-couch md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Faculty Lounges</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-building-columns md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Government Offices</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-hospital md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Hospital</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-gavel md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Law Office</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-basket-shopping md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Shopping Malls</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-train md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Mass Transit Stations</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa fa-masks-theater md:text-[40px] text-[44px] text-dark_brown"></i>
                    <p class="text-center text-gray-600 mt-2 text-16">Stadiums, Suites, and Arenas</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-light_beige pb-6 md:pl-10">
        <div class="grid grid-cols-1 sm:grid-cols-2">
            ...
            <!-- Botón visible solo en web -->
            <div class="hidden md:flex flex-col md:flex-row justify-end items-center gap-2 md:gap-4 pt-0 md:pt-10 pr-10">
                <div id="btn_getInTouch1" class="btn_red md:mt-0 ">
                    <a id="learn" href="#prepango-get-in-touch">Learn More</a>
                </div>
            </div>
        </div>

        <!-- Pasos -->
        <div class="grid grid-cols-1 sm:grid-cols-3 pt-6">
            <!-- Paso 1 -->
        ...
        <div class="md:hidden flex flex-col justify-center items-center gap-2 pt-5">
            <div id="btn_getInTouch2" class="btn_red stify-end items-center gap-2 ">
                <div id="btn_getInTouch1" class=" md:mt-0 sm:block">
                    <a id="get-in-touch-button" href="#prepango-get-in-touch">Learn More</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <h2 class="header_2 responsive-padding text-center md:text-left">
