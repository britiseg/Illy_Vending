<div class="container py-4 mx-auto">
    <div class="grid grid-cols-1 gap-4 mt-2 lg:grid-cols-3">
        ...
        <div class="flex col-span-2">
            <span class="top-2 header_black_new">
    ...
    <div class="grid grid-cols-1 gap-4 mt-2 lg:grid-cols-3">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('images/new/machine_new.png')}}"
                 class="hidden w-[260px] h-[479px] lg:block"
                 alt="Coffee">
        </div>

        <div class="flex flex-col justify-center">
            <p class="body_txt responsive-padding">
            ...
            <p class="hidden body_txt responsive-padding lg:block">
