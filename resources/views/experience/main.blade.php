<div class="container py-4 mx-auto">
    <div class="text-center mb-8">
        <div class="flex justify-center p-2 mt-4">
            <img src="{{ asset('images/experience/label.png') }}" class="hidden lg:block" alt="label">
            <img src="{{ asset('images/experience/label_mobile.png') }}" class="block lg:hidden" alt="label">
        </div>
    </div>
