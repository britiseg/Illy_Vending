<div class="container py-4 mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2" style="background: #F6F0EB">
        ...
        <div class="flex flex-col text-left">
            <p class="mt-4 font-bold text-red-600" style="font-style: normal;font-weight: 800; font-size: 28px;line-height: 150%;">
                Our Goal is to Delight Coffee Lovers
            </p>
            <p class="text-2xl mt-4 mb-1 text-gray-700">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2" style="background: #F6F0EB">
        ...
        <div class="flex flex-col text-left">
            <p class="mt-4 font-bold text-gray-700" style="font-style: normal;font-weight: 800; font-size: 28px;line-height: 150%;">
